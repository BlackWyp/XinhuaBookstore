...
<body>
    <article class="page-container">
        <form id="MyForm" name="MyForm" class="form form-horizontal"  method="post" enctype="multipart/form-data">
            <input type="hidden" id="userId" name="userId" value="${requestScope.user.userId}">
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>用户名：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" placeholder="" id="userName" name="userName" value="${requestScope.user.userName}">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>密码：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="password" class="input-text" placeholder="" id="password" name="password" value="${requestScope.user.password}">
                </div>
            </div>
            <input type="hidden" id="salt" name="salt" value="${requestScope.user.salt}">
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>图片：</label>&nbsp;&nbsp;<br> <img src="${requestScope.user.imgUrl}" style="width:200px;"/> <input type="file" name="imgUrl">
            </div>
            <div class="row cl">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $("#submitForm").click(function () {
                var bCanSubmit=valName()&&valPassword();
                if(bCanSubmit){
                    $.ajax({
                        url:"/XinhuaBookstore/servlet/UserServlet?type=updateUser",
                        type:"post",

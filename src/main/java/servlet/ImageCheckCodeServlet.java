...
public class ImageCheckCodeServlet extends HttpServlet {
    ...
    private String writeRandomNum(Graphics graphics) {
        /**
         * [\u4e00-\u9fa5]是汉字的区间正则表达式 \\u是代表是存在uncode码表中
         * 意思就是汉字都在\U（uncode）码表中4e00到9fa5之间
         */
        ...
        for (int i = 0; i < 4; i++) {
            ...
            //获取随机汉字
            String target = String.valueOf(base.charAt(new Random()
                    .nextInt(base.length())));
            checkCode+=target;
            // 设置字体弧度
